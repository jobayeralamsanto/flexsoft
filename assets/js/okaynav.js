  ...
  $.extend(Plugin.prototype, {
    init: function () {
      ...
      if (self.options.align_right) {
        self.navigation.append('<ul class="okayNav__nav--invisible transition-enabled nav-right" />').append('<a href="#" class="' + self.options.toggle_icon_class + ' okay-invisible">' + self.options.toggle_icon_content + "</a>");
      } else {
        self.navigation.prepend('<ul class="okayNav__nav--invisible transition-enabled nav-left" />').prepend('<a href="#" class="' + self.options.toggle_icon_class + ' okay-invisible">' + self.options.toggle_icon_content + "</a>");
      }
    ...
    initEvents: function () {
      ...
      self.document.on("click.okayNav", function (e) {
        ...
        if (self.nav_open === true && _target.closest(".okayNav").length == 0) self.closeInvisibleNav();
      ...
      self.document
        .on("touchstart.okayNav", function (e) {
          ...
          if (e.originalEvent.touches.length == 1) {
            ...
            if ((touch.pageX < 25 && self.options.align_right == false) || (touch.pageX > $(self.options.parent).outerWidth(true) - 25 && self.options.align_right == true) || self.nav_open === true) {
    ...
    recalcNav: function () {
      ...
      self.getHiddenItemCount() == 0 ? self.toggle_icon.addClass("okay-invisible") : self.toggle_icon.removeClass("okay-invisible");
    },
